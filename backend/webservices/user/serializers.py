...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if not username.isalnum():
            raise serializers.ValidationError('The user name should only contain alphanumeric character')
...
class LoginSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if not user.is_verified:
            raise AuthenticationFailed('Account has not been verified , try After email verification !!! ')
...
class SetNewPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        try:
            ...
            raise AuthenticationFailed('Password reset action interrupted', 500)
